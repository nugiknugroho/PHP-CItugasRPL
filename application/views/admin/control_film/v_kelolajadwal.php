                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li class="active">Kontrol Jadwal</li>
                        </ol>
                    </div>
                </div>
            </div>
...
<div class="container">
           ...
           <a href="<?php echo site_url('admin/laporanfilm') ?>" class="btn btn-danger" style="margin-top:20px;margin-bottom:20px;"><i class="fa fa-file-pdf-o"></i> Cetak PDF</a>
        <a href="<?php echo site_url('admin/kelolajadwal/tambah') ?>" class="btn btn-primary" style="margin-top:20px;margin-bottom:20px;"><i class="fa fa-plus"></i> Tambah</a>
    </div>
 ...
 <table class="table table-bordered table-striped">
            ...
            <tbody id="list-itens">
                ...
                <tr>
                    ...
                    <td>
                <center>
                <a href="<?php echo site_url('admin/kelolajadwal/delete/'.$value->id_tayang); ?>" class="btn btn-danger">
                    <i class="fa fa-trash"></i>
                </a>
                <a href="<?php echo site_url('admin/kelolajadwal/update/'.$value->id_tayang); ?>" class="btn btn-warning">
