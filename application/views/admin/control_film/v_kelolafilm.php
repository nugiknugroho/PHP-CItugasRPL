...
<div class="container">
        ...
        <a href="<?php echo site_url('admin/kelolafilm/tambah') ?>" class="btn btn-primary" style="margin-top:20px;margin-bottom:20px;"><i class="fa fa-plus"></i> Tambah</a>
    </div>
 ...
 <table class="table table-bordered table-striped">
            ...
            <tbody id="list-itens">
                ...
                <tr>
                    ...
                    <td>
                <center>
                <a href="<?php echo site_url('admin/kelolafilm/delete/'.$value->judul_film); ?>" class="btn btn-danger">
                    <i class="fa fa-trash"></i>
                </a>
                <a href="<?php echo site_url('admin/kelolafilm/update/'.$value->judul_film); ?>" class="btn btn-warning">
